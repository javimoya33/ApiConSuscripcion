...
namespace WebAPIAutores.Controllers
{
    ...
    public class LlavesAPIController: CustomBaseController
    {
        ...
        [HttpPost]
        public async Task<IActionResult> CrearLlave(CrearLlaveDTO crearLlaveDTO)
        {
            var usuarioId = ObtenerUsuarioId();
        ...
        [HttpPut]
        public async Task<IActionResult> ActualizarLlave(ActualizarLlaveDTO actualizarLlaveDTO)
        {
            var usuarioId = ObtenerUsuarioId();
