...
namespace WebAPIAutores.Controllers
{
    ...
    public class RestriccionesDominios: CustomBaseController
    {
        private readonly ApplicationDbContext context;

        public RestriccionesDominios(ApplicationDbContext context)
        {
        ...
        {
            var restriccionDB = await context.RestriccionesDominios.Include(x => x.Llave).FirstOrDefaultAsync(x => x.Id == id);
